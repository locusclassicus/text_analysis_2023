...
dict_sub
```
Используем другую укладку, также повернем подписи и 
...
Назначенный атрибут (это случайное число, но пусть оно означает, например, количество ссылок) можно закодировать на графе:
