...
У этого курса тоже есть свой css, в котором блок infobox (вы его видите как серый квадратик с определением) описано так:
...
Чуть более сложный пример: скрапинг html таблицы c фильмами IMDB.
...
Чтобы было удобнее работать с этими данными, их стоит переименовать и трансформировать. 
